...
<div class="max-w-3xl mx-auto">
    <div class="mb-6">
        <h2 class="text-xl font-black text-slate-800 tracking-tight">Tambah Lapangan Baru</h2>
        <p class="text-xs text-slate-400 font-semibold mt-1">Lengkapi informasi di bawah ini untuk menambahkan lapangan ke sistem.</p>
    </div>

    <div class="bg-white rounded-3xl border border-slate-200/80 shadow-sm overflow-hidden">
        <form action="{{ route('admin.lapangan.simpan') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="p-6 md:p-8 space-y-6">
                ...
                <div>
                    ...
                    <textarea name="fasilitas" id="fasilitas" rows="4" 
                        placeholder="Contoh:&#10;Rumput Sintetis Premium&#10;Lampu LED Malam&#10;Tribun Penonton&#10;Rompi & Bola disediakan"
                        class="block w-full px-4 py-3 rounded-xl border border-slate-200 shadow-sm bg-slate-50/50 text-sm font-semibold text-slate-700 placeholder-slate-400 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none transition-all font-mono"></textarea>
                ...
                {{-- Foto --}}
                <div>
                    <label for="foto" class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Foto Lapangan</label>
                    <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-slate-200 border-dashed rounded-2xl hover:border-indigo-400 transition-colors bg-slate-50/30">
                        <div class="space-y-2 text-center">
                            ...
                            <p class="text-[10px] text-slate-400 font-bold">Format PNG, JPG, JPEG maks. 2MB</p>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <select name="status" id="status" 
                        ...
                        <option value="nonaktif">Nonaktif (Sedang Perbaikan / Tutup)</option>
                    </select>
                </div>
            </div>
